    ...
    angular.module('app')
        .factory('HomePageSliderService', [
            ...
            function ($q, $interval, $timeout, $rootScope, $http, API, AuthService, CONSTANTS, ngDialog, ngToast) {
                ...
                var entity = 'home-page-slider';
                    var  listEmbeddedStr = '';

                factory.homePageSlider = {
                            id: '',
                            version: '',
                            createdAt: '',
                            updatedAt: '',
                ...
                factory.add = function (homePageSlider) {
                ...
                factory.update = function (id, homePageSlider) {
