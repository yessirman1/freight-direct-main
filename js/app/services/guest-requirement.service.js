(function () {
    ...
    angular.module('app')
        .factory('GuestRequirementService', [
            ...
            function ($q, $interval, $timeout, $rootScope, $http, API, AuthService, CONSTANTS, ngDialog, ngToast) {
                ...
                var entity = 'guest-requirement';
                    var  listEmbeddedStr = '&embedded=product';

                factory.guestRequirement = {
                            id: '',
                            version: '',
                            createdAt: '',
                            updatedAt: '',
                ...
                factory.add = function (guestRequirement) {
                ...
                factory.update = function (id, guestRequirement) {
