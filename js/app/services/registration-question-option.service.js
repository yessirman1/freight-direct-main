(function () {
    ...
    angular.module('app')
        .factory('RegistrationQuestionOptionService', [
            ...
            function ($q, $interval, $timeout, $rootScope, $http, API, AuthService, CONSTANTS, ngDialog, ngToast) {
                ...
                var entity = 'registration-question-option';
                    var  listEmbeddedStr = '&embedded=registration-question';

                factory.registrationQuestionOption = {
                            id: '',
                            version: '',
                            createdAt: '',
                            updatedAt: '',
                ...
                factory.add = function (registrationQuestionOption) {
                    ...
                    return $q(
                        function (resolve, reject) {
                            ...
                            return $http({
                                ...
                                data: registrationQuestionOption
                            }).then(
                                function (resp) {
                                    resolve(resp);
                                }, function (err) {
                ...
                factory.update = function (id, registrationQuestionOption) {
