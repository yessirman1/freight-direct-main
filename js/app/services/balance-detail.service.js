    ...
    angular.module('app')
        .factory('BalanceDetailService', [
            ...
            function ($q, $interval, $timeout, $rootScope, $http, API, AuthService, CONSTANTS, ngDialog, ngToast) {
                ...
                var entity = 'balance-detail';
                    var  listEmbeddedStr = '&embedded=balance';

                factory.balanceDetail = {
                            id: '',
                            version: '',
                            createdAt: '',
                            updatedAt: '',
                ...
                factory.add = function (balanceDetail) {
                ...
                factory.update = function (id, balanceDetail) {
