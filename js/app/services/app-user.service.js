    ...
    angular.module('app')
        .factory('AppUserService', [
            ...
            function ($q, $interval, $timeout, $rootScope, $http, API, AuthService, CONSTANTS, ngDialog, ngToast) {
                ...
                var entity = 'app-user';
                    var  listEmbeddedStr = '&embedded=role,branch,introduced-by,attachments,registration-answers';
                ...
                factory.update = function (id, appUser) {
