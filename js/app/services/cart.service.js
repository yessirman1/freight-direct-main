    ...
    angular.module('app')
        .factory('CartService', [
            ...
            function ($q, $interval, $timeout, $rootScope, $http, API, AuthService, CONSTANTS, ngDialog, ngToast) {
                ...
                var entity = 'cart';
                    var  listEmbeddedStr = '&embedded=cart-item,cart-item.product-single,cart-item.product-single.main-images';
                ...
                factory.update = function (id, cart) {
