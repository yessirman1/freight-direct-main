    ...
    angular.module('app')
        .factory('ShipmentDetailService', [
            ...
            function ($q, $interval, $timeout, $rootScope, $http, API, AuthService, CONSTANTS, ngDialog, ngToast) {
                ...
                var entity = 'shipment-detail';
                    var  listEmbeddedStr = '&embedded=shipment';

                factory.shipmentDetail = {
                            id: '',
                            version: '',
                            createdAt: '',
                            updatedAt: '',
                ...
                factory.add = function (shipmentDetail) {
                ...
                factory.update = function (id, shipmentDetail) {
