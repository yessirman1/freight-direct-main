(function () {
    ...
    angular.module('app')
        .factory('InventoryDetailService', [
            ...
            function ($q, $interval, $timeout, $rootScope, $http, API, AuthService, CONSTANTS, ngDialog, ngToast) {
                ...
                var entity = 'inventory-detail';
                    var  listEmbeddedStr = '&embedded=product-single';

                factory.inventoryDetail = {
                            id: '',
                            version: '',
                            createdAt: '',
                            updatedAt: '',
                ...
                factory.add = function (inventoryDetail) {
                ...
                factory.update = function (id, inventoryDetail) {
